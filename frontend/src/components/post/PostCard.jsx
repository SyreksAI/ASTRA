    ...
    return (
        <div className="post-item">
            <div className="post-item-header">
                <img src={authorAvatar} alt={authorName} className="post-item-avatar" />
                <div className="post-item-user-info">
                    <div className="post-item-user-name">{authorName}</div>
                    <div className="post-item-user-handle">{authorHandle}</div>
                </div>
